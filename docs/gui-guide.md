...
For installation and screenshots, see the [project README](../README.md). Run all commands below from the repository root.
...
For a safe test run, first copy the tiny fixture using the
[demo setup instructions](../README.md#quick-start). Then open that copy:

```powershell
python run_gui.py --dataset dataset\demo
```
...
For a safe fixture test, use the demo copy created above:
